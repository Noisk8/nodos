...
export default function Tarjeta({ title, subtitle, imageSrc, imageAlt,titulo, hyperlink }: CardProps) {
  return (
    <Card className="py-2 md:py-4 bg-gray-900 p-2 md:p-5 rounded-lg shadow-xl text-purple-300 w-full" style={{boxShadow: "0 8px 12px -2px rgba(255, 0, 255, 0.1), 0 4px 8px -2px rgba(255, 0, 255, 0.06)"}}>
