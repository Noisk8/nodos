            ...
            <div className="max-w-1xl mx-auto mt-8" style={{ boxShadow: "0 8px 12px -2px rgba(255, 0, 255, 0.1), 0 4px 8px -2px rgba(255, 0, 255, 0.06)" }}>
                <div className="shadow-lg rounded-lg overflow-hidden text-purple-300 bg-gray-900 mt-8">
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4 p-4">
                        ...
                        <div className="col-span-full text-center pb-4 pt-8">  <a href="https://harbourmaster.nymtech.net/mixnode/869" target="_blank" className="bg-gray-800 hover:bg-purple-300 text-white font-bold py-4 px-4 rounded">
                                Ver en Explorer
                            </a></div>
